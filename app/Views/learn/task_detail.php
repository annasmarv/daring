                            ...
                            <div class="card-body">
                                <form method="post" action="<?= base_url('learn/task/saven1/'.$detail->taskid); ?>">
                                    <div class="d-flex align-items-center mb-4">
                                        <div class="btn-group">
                                            <a href="#" class="btn btn-md btn-danger btn-round" data-toggle="modal" data-target="#uploadnilai"><b>Upload Nislai</b></a>
                                        ...
                                        <div class="ml-auto">
                                            <a href="<?= base_url(); ?>/ujian"><button type="button" class="btn btn-md btn-light btn-round"><i class="fa fa-chevron-left"></i> Kembali</button></a>
                                        </div>
                                    </div>
