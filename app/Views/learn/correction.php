        ...
        <div class="col">
          <div class="card">
            <div class="card-body">
              <div class="d-flex align-items-center mb-4">
                ...
                <div class="ml-auto">
                  <div class="dropdown sub-dropdown">
                    <a href="<?= base_url(); ?>/learn/task/<?= $uri->getSegment(4); ?>"><button class="btn btn-md btn-light btn-round"><i class="fa fa-chevron-left"></i> Kembali</button></a>
              ...
              <form action="<?= base_url(); ?>/learn/correction/save" method="post">
              <?= csrf_field(); ?>
              ...
              <hr>
              <?php endforeach ?>
                      <center><input type="submit" id="rTask" name="" class="btn btn-cyan btn-round" value="SIMPAN"></center>
                    <a href="<?= base_url(); ?>/learn/task/<?= $uri->getSegment(4); ?>"><button class="btn btn-md btn-light btn-round"><i class="fa fa-chevron-left"></i> Kembali</button></a>
                  </div>
                </form>
            </div>
