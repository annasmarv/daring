                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center mb-4">
                                    <h4 class="card-title">Daftar Jenis Penilaian</h4>
                                    <div class="ml-auto">
                                    ...
                                    <table id="zero_config" style="width: 100%" class="table table-striped v-middle mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-0 font-weight-medium text-muted">Penilaian</th>
                                                <th class="border-0 font-weight-medium text-muted" width="200">Kode</th>
                                                <th class="border-0 font-weight-medium text-muted" width="65"></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php $no=1; foreach ($tasktypes as $row): ?>
                                            <tr>
                                            	<td><?= $no++; ?></td>
                                            	<td><?= $row['task_type_name']; ?></td>
                                            	<td><?= $row['task_type_code']; ?></td>
                                            	<td>
                                            		<div class="btn-group">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="myModalLabel">Tambah Jenis Penilaian</h4>
