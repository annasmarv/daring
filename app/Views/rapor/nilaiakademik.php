...
<?= $this->section('content'); ?>
                        ...
                        <div class="card">
                        	<div class="card-header">
	                            <div class="row align-items-center">
	                            	<div class="col-8">
	                                	<h4 class="mb-0 card-title">Nilai Pengetahuan & Keterampilan</h4>
	                            	</div>
	                            	<div class="col-4 text-right">
                                        <?php if ($_GET['rekapNilai']): ?>
                                        <button class="btn btn-sm btn-success" data-toggle="modal" data-target="#nilaiakademik"><i class="fa fa-upload"> Upload</i></button>
                                        <?php endif ?>
                                    </div>
	                            </div>
                            </div>
                                            ...
                                            <div class="col-3">
                                                <select class="form-control" name="mapel">
                                                    ...
                                                    <?php foreach ($subjects as $subject): ?>
                                                        <option <?= ($_GET['mapel'] == $subject['subject_id']) ? 'selected' : '' ?> value="<?= $subject['subject_id']; ?>"><?= $subject['subject_name']; ?></option>
                                                    <?php endforeach ?>
                                                </select>
                                            </div>
                                            <div class="col-3">
            ...
            <div id="nilaiakademik" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <form method="post" enctype="multipart/form-data" action="<?= base_url(); ?>/rapor/import/<?= $_GET['mapel']; ?>">
                            <div class="modal-body">
                                <div class="container">
                                    <input name="upload" type="file"><br /><br>
                                    <p>Format Upload download <a href="<?= base_url(); ?>/temp/rapor/nilai - <?= $_GET['kelas']; ?>.xlsx"><strong>Disini </strong></a></p>
                                </div>
                            </div>
