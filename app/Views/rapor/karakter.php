                        ...
                        <div class="card">
                        	<div class="card-header">
	                            <div class="row align-items-center">
	                            	<div class="col-8">
	                                	<h4 class="mb-0 card-title">Pengembangan Karakter</h4>
	                            	</div>
                                ...
                                <div class="table-responsive">
                                    <form action="#" method="post">
                                        <table class="table wrap v-middle mb-0 table-striped">
                                            <thead>
                                                <tr>
                                                    <th colspan="10" style="text-align: right;"><input type="submit" class="btn btn-cyan" name="editall" value="Simpan"></th>
                                                </tr>
                                                <tr>
            ...
            <div id="catatanakademik" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <form method="post" enctype="multipart/form-data" action="<?= base_url(); ?>/rapor/importkarakter">
                            <div class="modal-body">
                                <div class="container">
                                    <input name="upload" type="file"><br /><br>
                                    <p>Format Upload download <a href="<?= base_url(); ?>/temp/rapor/karakter - <?= $_GET['kelas']; ?>.xlsx"><strong>Disini </strong></a></p>
                                </div>
                            </div>
