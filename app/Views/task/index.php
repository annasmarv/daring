                                ...
                                <div>
                                    <!-- <form method="get">
                                        <div class="form-group">
                                            <select class="form-control multiselect" name="kelas[]" multiple="multiple">
                                                <?php foreach ($classes as $class): ?>
                                                    <option value="<?= $class['class_group_id']; ?>"><?= $class['class_group_name']; ?></option>
                                                <?php endforeach ?>
                                            </select>
                                            <select class="form-control multiselect" name="mapel[]" multiple="multiple">
                                                <?php foreach ($subjects as $subject): ?>
                                                    <option value="<?= $subject['subject_id']; ?>"><?= $subject['subject_name']; ?></option>
                                            <?php endforeach ?>
                                            </select>
                                            <select class="form-control multiselect" name="jenis[]" multiple="multiple">
                                                <?php foreach ($subjects as $subject): ?>
                                                    <option value="<?= $subject['subject_id']; ?>"><?= $subject['subject_name']; ?></option>
                                            <?php endforeach ?>
                                            </select>
            ...
            <script>
                $('#myDataTable1').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: '<?= base_url(); ?>/learn/task/get_task/<?= null !== get_cookie('periodyear')?get_cookie('periodyear'):period()->id ?>'
                    },
                    order: [[0,"desc"]],
                    columns: [
