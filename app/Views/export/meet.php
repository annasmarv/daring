        ...
        <div class='form' style='text-align: justify;text-justify: inter-word;'>
            ...
            <table  class='beda' align='left' width='100' style='width: 100%;margin: 10px 0;'>
                <tr>
                    ...
                    <td width="10">:</td>
                    <td><p><?= $meet->fullname; ?></p></td>
                </tr>
                <tr>
                    <td width="150"><p>Mata Pelajaran</p></td>
                    <td width="10">:</td>
                    <td><p><?= $meet->subject_name; ?></p></td>
                </tr>
                <tr>
                    <td width="150"><p>Tema</p></td>
                    <td width="10">:</td>
                    <td><p><?= $meet->meet_name; ?></p></td>
                </tr>
                <tr>
                    <td width="150"><p>Tanggal / Waktu</p></td>
                    <td width="10">:</td>
                    <td><p><p><?= tgl_indo($meet->date); ?> / <?= $meet->time_start ?> - <?= $meet->time_finish ?></p></p></td>
                </tr>
                <tr>
                    <td width="150"><p>Kelas</p></td>
                    <td width="10">:</td>
                    <td><p><?= $meet->class_group_name; ?></p></td>
                </tr>
            </table>
            ...
            <table  class='initabel' align='left' width='100' style='width: 100%;margin: 1px 0;'>
                <thead>
                    <tr>
                        <td rowspan="2" width='1' align="center">No.</td>
                        <td rowspan="2" width='180'>Nama</td>
                        <td rowspan="2" width="75">Jam Masuk</td>
                        <td colspan="3">Aktifitas Siswa</td>
                    </tr>
                    <tr>
                        <td>Baca Materi</td>
                        <td>Buat Tugas</td>
                ...
                <tbody>
                   <?php $no = 1; foreach ($orang as $data): ?>
                       <tr>
                           ...
                           <td align="center"><?= (isset($data['read_date']) ? "v" : "") ?></td>
                           <td align="center"><?= (isset($data['date_task']) ? "v" : "") ?></td>
                           <td align="center"><?= (isset($data['interactive_id']) ? "v" : "") ?> </td>
                       </tr>
                   <?php endforeach ?>
                </tbody>
            </table>
