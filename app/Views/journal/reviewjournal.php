                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        <div class="card border-primary">
                            <div class="card-body">
                                <h3 class="card-title">Jurnal Pembelajaran</h3><br>          
                                <table>
                                    <tr>
                                        <td width="150">Guru</td><td width="30">:</td><td><?= $jurnal['fullname']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Mata Pelajaran</td><td>:</td><td><?= $jurnal['subject_name']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Kelas</td><td>:</td><td><?= $jurnal['class_group_name']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Tanggal Buat</td><td>:</td><td><?= $jurnal['created_at']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Tanggal Update</td><td>:</td><td><?= $jurnal['updated_at']; ?></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12 col-lg-12">
                        <div class="card border-primary">
                            <div class="card-body">
                                <h3 class="card-title"><?= $jurnal['subject_name'];?> - <?= $jurnal['class_group_name']; ?></h3>
                                <p class="mt-4">
                                    <strong>Catatan Pembelajaran</strong><br>
                                    <span><?= $jurnal['note']; ?></span>
                                </p>
                                <p class="mt-4">
                                    <strong>Refleksi Pembelajaran</strong><br>
                                    <span><?= $jurnal['reflection']; ?></span>
                                </p>
                            </div>
                        </div>
                    </div>
