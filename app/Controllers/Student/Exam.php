...
class Exam extends BaseController
{
    ...
    date_default_timezone_set('Asia/Jakarta');
		...
		$data = [
            ...
            'answered' => $this->answerModel->get_answered_status($user,$id),
    ...
    date_default_timezone_set('Asia/Jakarta');
		...
		return redirect()->to(base_url('student/exam/'.$task_id));
	}
    ...
    public function save()
    {
        ...
        return redirect()->to(base_url('student/exam/'.$task_id.'?page_qna='.$sort));
    }
